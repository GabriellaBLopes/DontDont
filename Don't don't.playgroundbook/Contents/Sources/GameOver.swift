...
public class GameOver: SKScene {
  ...
  public override func didMove(to view: SKView) {
    ...
    swipeIndicator?.run(SKAction.repeatForever(SKAction.sequence([swipeIndicatorAnimationsGroup, SKAction.wait(forDuration: 1.5), SKAction.moveTo(x: -165, duration: 0),SKAction.fadeAlpha(to: 0.6, duration: 0.2)])))
  }
